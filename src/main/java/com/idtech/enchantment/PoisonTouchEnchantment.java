...
public class PoisonTouchEnchantment extends Enchantment {
    ...
    public static Enchantment INSTANCE = new WitherTouchEnchantment(Rarity.UNCOMMON, EquipmentSlot.MAINHAND).setRegistryName("poison_touch");

    // Constructor
    protected PoisonTouchEnchantment(Rarity rarityIn, EquipmentSlot... slots) {
    ...
    protected boolean checkCompatibility(Enchantment other) {
        return super.checkCompatibility(other) && other != WitherTouchEnchantment.INSTANCE;
    }
    ...
    public void doPostAttack(LivingEntity user, Entity target, int level) {
        ...
        if (target instanceof LivingEntity) {
            ...
            int i = level * 50;
            livingentity.addEffect(new MobEffectInstance(MobEffects.POISON, i, 1));
