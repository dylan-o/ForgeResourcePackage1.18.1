...
public class TunnelVisionCurse extends Enchantment {

    // Set up Enchantment Instance
    public static Enchantment INSTANCE = new TunnelVisionCurse(Rarity.UNCOMMON, EquipmentSlot.FEET).setRegistryName("blind_fighter");

    // Constructor
    protected TunnelVisionCurse(Rarity rarityIn, EquipmentSlot... slots) {
